...
from django.views.generic.base import View, HttpResponseRedirect, HttpResponse, reverse
...
class Requirement(View):
    form_class = forms.CommentLikeForm
    template_name = 'comment.html'

    def get(self, request, *args, **kwargs):
        form = self.form_class()
        comment = models.CommentLike.objects.all()
...
class UpdateCommentVote(LoginRequiredMixin, View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        try:
            ...
            comment.dis_likes
        except models.CommentLike.dis_likes.RelatedObjectDoesNotExist as identifier:
            models.DisLike.objects.create(comment = comment)

        try:
            # If child Like model doesnot exit then create
            comment.likes
        except models.CommentLike.likes.RelatedObjectDoesNotExist as identifier:
